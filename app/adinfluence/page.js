...
const Adinfluence = () => {
  ...
  return (
    <div className="relative z-0 flex flex-col items-center justify-center gap-20 bg-zinc-50">
      ...
      {isPopUp && (
        <div className="fixed top-0 left-0 z-50 w-full h-screen px-2 sm:px-0 flex flex-col items-center justify-center backdrop-blur-lg">
          <div className="w-full sm:w-[550px] p-4 rounded-2xl bg-white shadow-xl shadow-zinc-900/5 fade-in">
            <button
