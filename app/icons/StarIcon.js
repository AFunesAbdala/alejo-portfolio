export default function StarIcon({ animation }) {
  return (
    <div className="relative flex justify-center items-center">
      ...
      {animation && <div className="absolute -z-[1] w-1 h-1 rounded-full border border-zinc-400 pulse-ping"></div>}
      {animation && <div className="absolute -z-[1] w-1 h-1 rounded-full border border-zinc-400 pulse-ping" style={{ animationDelay: '300ms' }}></div>}
    </div>
  );
}
