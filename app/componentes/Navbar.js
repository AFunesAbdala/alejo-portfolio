...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-5 z-50 w-full max-w-349 flex sm:flex-row flex-col justify-between items-center lg:gap-12.5 gap-2 py-4 pl-4 pr-5 bg-zinc-50/25 border border-zinc-50/25 backdrop-blur rounded-full">
      ...
      <div className="text-sm lg:text-right text-center text-zinc-900">
